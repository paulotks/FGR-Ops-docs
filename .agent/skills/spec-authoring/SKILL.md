---
name: spec-authoring
description: "Guia de redação de seções SPEC com rastreio bidirecional correto. Acionado ao redigir ou atualizar seções SPEC, adicionar novos módulos técnicos, ou documentar decisões arquiteturais."
---
...
3. **Para cada decisão arquitetural** tomada ao escrever, registre em `docs/audit/decisions-log.md` como `DEC-NNN` (próxima disponível: DEC-019)
