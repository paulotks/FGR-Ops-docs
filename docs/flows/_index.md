...
| [02-execucao-campo-operador.md](02-execucao-campo-operador.md) | Operador: check-in → demanda ativa → pausar/concluir → cancelamento direto com justificativa (DEC-019). | REQ-JOR-004, REQ-FUNC-006…009, REQ-ACE-004…005 | [02-jornada-usuario.md](../PRD/02-jornada-usuario.md) |
