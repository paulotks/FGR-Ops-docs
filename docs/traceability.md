...
| `REQ-FUNC-013` | [PRD/03-requisitos-funcionais.md](PRD/03-requisitos-funcionais.md) | [SPEC/07-design-ui-logica.md](SPEC/07-design-ui-logica.md) | Pop-up de notificação (alerta sonoro + vibração) quando nova demanda chega a operador com fila vazia; opções "Iniciar Agora" / "Iniciar Depois (Perfilar)"; sem recusa. Fila ativa: entrada silenciosa na fila + card expandido. Rastreio via `REQ-JOR-004`. |
...
| `REQ-ACE-009` | [PRD/05-criterios-aceite.md](PRD/05-criterios-aceite.md) | [SPEC/07-design-ui-logica.md](SPEC/07-design-ui-logica.md), [SPEC/06-definicoes-complementares.md](SPEC/06-definicoes-complementares.md) | Critérios testáveis para REQ-FUNC-013: pop-up fila vazia (5 cenários Gherkin), vibração+som, "Iniciar Agora"/"Perfilar", fila ativa silenciosa, reconexão offline. |
