...
- **Bloqueantes**
  - ~~`SPEC-M01-001`~~ - `REQ-SCO-003` **resolvido** (Fase 1.3 — 2026-03-20). Cobertura adicionada em `docs/SPEC/00-visao-arquitetura.md` §Arquitetura Tatica (DDD), com referencia cruzada a `docs/SPEC/02-modelo-dados.md`.
- **Importantes**
