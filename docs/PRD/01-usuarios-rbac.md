...
- O perfil `UsuarioInternoFGR` tem acesso dual: painel web gerencial (leitura total do Machinery-Link) e aplicativo mobile para criação de demandas simples. Não possui poderes de cancelamento, redistribuição, agendamento ou gestão de cadastros.
