...
| [03-requisitos-funcionais.md](03-requisitos-funcionais.md)         | Requisitos funcionais | Requisitos funcionais do MVP operacional: estados, filtros, expediente, alocação manual, cronómetros, cancelamentos, CRUD de Empreiteira, notificação de demanda para operador com fila vazia e rollover/redistribuição de demandas entre dias. | REQ-FUNC-001…014                                                                           | [01-modulos-plataforma.md](../SPEC/01-modulos-plataforma.md), [02-modelo-dados.md](../SPEC/02-modelo-dados.md), [03-fila-scoring-estados-sla.md](../SPEC/03-fila-scoring-estados-sla.md), [08-api-contratos.md](../SPEC/08-api-contratos.md)                               |
...
| [05-criterios-aceite.md](05-criterios-aceite.md)                   | Critérios de aceite   | Critérios testáveis do PRD para RBAC, isolamento e operação do Machinery Link; segurança de token permanece pendente. REQ-ACE-010 cobre rollover e redistribuição de demandas entre dias (DEC-025). | REQ-ACE-001…006, REQ-ACE-008, REQ-ACE-009, REQ-ACE-010                                    | [04-rbac-permissoes.md](../SPEC/04-rbac-permissoes.md), [03-fila-scoring-estados-sla.md](../SPEC/03-fila-scoring-estados-sla.md), [06-definicoes-complementares.md](../SPEC/06-definicoes-complementares.md)                                                               |
...
REQ-FUNC-011, REQ-FUNC-012, REQ-FUNC-013, REQ-FUNC-014
...
REQ-ACE-001, REQ-ACE-002, REQ-ACE-003, REQ-ACE-004, REQ-ACE-005, REQ-ACE-006, REQ-ACE-007, REQ-ACE-008, REQ-ACE-009, REQ-ACE-010
