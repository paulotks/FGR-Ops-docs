...
- **TurnoAjudante** *(fora do MVP-15jul — adiado p/ Fase 2, DEC-041)*: registro cronológico associado ao `RegistroExpediente` que mapeia a relação temporal entre ajudante e par operador-máquina.
